...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b6b458, const void *arg_0xb7b6b5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b1c8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79c6840), 
int (*key_eq_fn)(void *arg_0xb79c6c88, void *arg_0xb79c6e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78959b8, int arg_0xb7895b10);
static double RandomUniform(void );
...
#line 153
{
  ...
  sim_log_debug(169U, "radio_rec", "[receive] - Message received with length %u, processing...\n", sizeof(my_msg_t ));
...
#line 166
      sim_log_debug(170U, "radio_rec", "[receive] - Received packet at time %s\n", sim_time_string());
      sim_log_debug(171U, "radio_rec", "[receive] - >>>Pack \n", sendAckC$Packet$payloadLength(buf));
      sim_log_debug_clear(172U, "radio_rec", "\t\t[receive] - Payload: \n");
      sim_log_debug_clear(173U, "radio_rec", "\t\t[receive] - counter: %hhu \n", __nesc_ntoh_uint16(msg->counter.nxdata));
      sim_log_debug_clear(174U, "radio_rec", "\t\t[receive] - type: %hhu \n", __nesc_ntoh_uint8(msg->type.nxdata));
      sim_log_debug_clear(175U, "radio_rec", "\t\t[receive] - sensor: %u\n", __nesc_ntoh_uint16(msg->sensor.nxdata));

      if (__nesc_ntoh_uint8(msg->type.nxdata) == 1) {
          sim_log_debug(176U, "radio_rec", "[receive] - message received is REQ\n");
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7636178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7636178, msg, payload, len);
#line 78
...
{
  if (err == SUCCESS) {
      sim_log_debug(155U, "radio", "[startDone] - Radio on on node %d!\n", TOS_NODE_ID);
      sendAckC$MilliTimer$startPeriodic(1000);
    }
  else 
#line 85
    {
      sim_log_error(156U, "radio", "[startDone] - Radio failed to start, retrying...\n");
...
#line 92
{
  sim_log_debug(157U, "boot", "[stopDone] - Radio stopped!\n");
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74cb258, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74cb258) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74cb258, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77f1650){
#line 75
  switch (arg_0xb77f1650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77f1650);
#line 75
      break;
#line 75
    }
...
#line 97
{
  ...
  if (TOS_NODE_ID == 1) {
      ...
      sim_log_debug(158U, "timer", "[fired] - Timer fired, counter is %hu.\n", sendAckC$counter[sim_node()]);
...
#line 195
  __nesc_hton_uint8(rcm->type.nxdata, 2);
  __nesc_hton_uint16(rcm->sensor.nxdata, data);
  __nesc_hton_uint16(rcm->counter.nxdata, sendAckC$counter[sim_node()]);
  sim_log_debug(177U, "radio_send", "[readDone] - Data ready to be sent\n");
  if (sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]) == SUCCESS) {
      if (sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(178U, "radio_send", "[readDone] - Sending packet...");
          sim_log_debug_clear(179U, "radio_send", " at time %s \n", sim_time_string());
        }
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb734cc70){
#line 83
  switch (arg_0xb734cc70) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb734cc70);
#line 83
      break;
#line 83
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74cbc40, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74cbc40, addr, msg, len);
#line 80
...
#line 75
{
  sim_log_debug(154U, "boot", "[Boot] - Application booted.\n");
  sendAckC$AMControl$start();
}
...
#line 126
  if (&sendAckC$packet[sim_node()] == buf && err == SUCCESS) {
      sim_log_debug(159U, "radio_send", "[sendDone] - Packet sent...");
      sim_log_debug_clear(160U, "radio_send", " at time %s \n", sim_time_string());

      if (sendAckC$PacketAcknowledgements$wasAcked(buf)) {
          sim_log_debug(161U, "radio_rec", "\t\t[sendDone] - Payload of received message:\n");
          sim_log_debug(162U, "radio_rec", "\t\t[sendDone] - counter: %u\n", __nesc_ntoh_uint16(msg->counter.nxdata));
          sim_log_debug(163U, "radio_rec", "\t\t[sendDone] - sensor: %u\n", __nesc_ntoh_uint16(msg->sensor.nxdata));
          sim_log_debug(164U, "radio_rec", "\t\t[sendDone] - type: %u\n", __nesc_ntoh_uint8(msg->type.nxdata));
          if (__nesc_ntoh_uint8(msg->type.nxdata) == 2) {
              sim_log_debug(165U, "radio_pack", "[sendDone] - Message acked RESP\n");
            }
          else 

            {
              sim_log_debug(166U, "radio_pack", "[sendDone] - Message acked REQ, stopping timer\n");
...
#line 145
    {
      sim_log_error(167U, "radio_send", "[sendDone] - packet not acked");
      sim_log_error(168U, "radio_send", "sending request again\n");
      sendAckC$sendReq();
    }
}
...
#line 47
  ...
  __nesc_hton_uint16(rcm->counter.nxdata, sendAckC$counter[sim_node()]);
  __nesc_hton_uint8(rcm->type.nxdata, 1);
  sim_log_debug(148U, "radio_pack", "[sendReq] - Preparing the message... \n");
  if (sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]) == SUCCESS) {
      if (sendAckC$AMSend$send(2, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(149U, "radio_send", "[sendReq] - Packet passed to lower layer successfully!\n");
          sim_log_debug(150U, "radio_send", "[sendReq] - >>>Pack\n");
          sim_log_debug_clear(151U, "radio_send", "\t\t[sendReq] - Payload Sent\n");
          sim_log_debug_clear(152U, "radio_send", "\t\t[sendReq] - counter: %hhu \n ", __nesc_ntoh_uint16(rcm->counter.nxdata));
          sim_log_debug_clear(153U, "radio_send", "\t\t[sendReq] - type: %hhu \n", __nesc_ntoh_uint8(rcm->type.nxdata));
        }
    }
}
